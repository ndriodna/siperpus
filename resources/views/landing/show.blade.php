...
<div class="card lg:card-side shadow-lg bg-base-100">
	<figure>
		<img src="{{$buku->cover ? asset($buku->cover) : asset('cover-default.svg')}}" alt=""  class="max-h-fit">
	</figure>
	<div class="card-body">
		...
		<div class="card-actions">
			...
			<button type="submit" {{($buku->stok > 0) ? '' : 'disabled'}} class="btn btn-primary">Pinjam</button>
				</div>
			</form>
		</div>
	</div>

<aside class="flex flex-col justify-between border-r border-base-400 bg-base-100 text-base-content w-80 overflow-hidden">
  ...
  <div class="overflow-y-auto h-screen mb-4">
    ...
    <li class="w-90"><a href="{{route('user.index')}}" class="capitalize"><i data-feather="user" class="mr-2"></i>profile</a></li>
    <li>
    ...
    <li class="mb-2"><a href="{{route('buku.index')}}" class="capitalize"><i data-feather="book" class="mr-2"></i>Buku
    </a></li>
    <li class="mb-2"><a href="{{route('rak.index')}}" class="capitalize"><i data-feather="archive" class="mr-2"></i>Rak Buku
    </a></li> 
